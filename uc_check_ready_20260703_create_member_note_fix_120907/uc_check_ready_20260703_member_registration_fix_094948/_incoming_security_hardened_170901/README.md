...
- `supabase/01_security_hardening.sql`, `supabase/02_member_registration_fields.sql`, `supabase/20260629_kiosk_demo1_hardening.sql`은 이전 패치 호환용 파일입니다. 새 환경에서는 위 순서의 `001~004` 파일을 사용하세요.
